...
<div class="modal modal-top fade" id="modaleadd" tabindex="-1">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="role" name="role" placeholder="teacher or manager" autofocus>
            </div>
            </div>
            <div class="modal-footer">
...
<div class="modal modal-top fade" id="modaleaddstudent" tabindex="-1">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="fee" name="fee" placeholder="fee paid" />
          </div>
          </div>
          <div class="modal-footer">
